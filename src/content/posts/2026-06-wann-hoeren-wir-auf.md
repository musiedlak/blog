---
title: "Wann hören wir auf? Die Frage, die zu selten rechtzeitig gestellt wird."
...
Hier liegt für mich der Kern. Die Bewegungen, die gegen die einfachen Mittel arbeiten, haben längst Namen. Verlustaversion[^verlust], Sunk-Cost[^sunk], Bestätigungsfehler[^conf], man kann sie in jedem Lehrbuch nachlesen. Und genau das ist das Verblüffende: Wir kennen sie alle und tun es trotzdem. Wenn ich mich frage, woran das liegt, lande ich nicht bei Unwissen oder Faulheit, sondern bei etwas Unbequemerem: Das eine Mittel, das dagegen hilft, kostet genau dann die meiste Überwindung, wenn es am nötigsten ist.

Solche Abbruch- und Erfolgskriterien sind deshalb kein Bürokratie-Akt, sondern eine Form von Selbstschutz. Mit noch kühlem Kopf entscheidet man vorab für die hitzige Phase, die kommt. Ein passendes Beispiel dafür stammt aus einer Dokumentation, die ich kürzlich gesehen habe. Bergsteiger legen vor dem Aufstieg eine Umkehrzeit fest: eine Uhrzeit, zu der sie umdrehen, auch wenn der Gipfel zum Greifen nah ist. Dort oben, dem Ziel so nah, trifft kaum jemand diese Entscheidung noch nüchtern. Und die meisten Unglücke passieren nicht am Gipfel, sondern beim Abstieg, wenn die Kräfte überschätzt wurden.[^everest] Die Festlegung schützt nicht vor der Begeisterung. Sie verhindert nur, dass die spätere Entscheidung ausgerechnet dann fällt, wenn niemand mehr klar denkt.
...
Ein Abbruchkriterium an Umsatz, Deckungsbeitrag oder Amortisation kommt strukturell zu spät: Ob eine große Idee Ertrag bringt, zeigt sich oft erst nach Jahren. Ob dagegen die eine, erfolgskritische Annahme hält – die, über die die ganze Idee kippt –, lässt sich meist in Wochen oder Monaten belastbar einschätzen. Dorthin gehört das Signal, nicht an die Kennzahl.

### 2 — Vorab gesetzt, weil es später niemand mehr nüchtern setzt

Das Kriterium wird ausgerechnet im Moment der größten Begeisterung verlangt, und da wirkt es wie Verrat an der eigenen Idee. Danach arbeiten Verlustaversion, Sunk-Cost und Bestätigungsfehler alle gegen den rechtzeitigen Abbruch. Deshalb hilft nur, mit noch kühlem Kopf vorab zu entscheiden – wie die Umkehrzeit, die der Bergsteiger vor dem Aufstieg festlegt, nicht erst oben am Gipfel.

### 3 — Ohne benannte Verantwortung bleibt die Reißleine liegen

Die Bedingung allein reicht nicht. Es braucht zwei Rollen: wer dafür verantwortlich ist, dass das Kriterium eingehalten wird, und wer bei Eintritt entscheidet, was passiert. Sonst legt am Ende die Zahl die Person aus, die am meisten an der Idee hängt – und die Reißleine wird nicht gezogen.

### 4 — Abbruchkriterien verbieten Beharrlichkeit nicht

Der Einwand, feste Kriterien beendeten gerade die Ideen, die nur länger gebraucht hätten, stimmt nur, wenn das Kriterium an der ganzen Idee hängt. Hängt es am kritischsten Risiko, sorgt es für das Gegenteil: Man hält an dem fest, was noch eine Chance hat, statt aus Stolz an dem, was keine Zukunft hat. Erst wenn keine ernsthafte Idee für einen Kurswechsel bleibt, ist wirklich Schluss.

[^andon]: This American Life, Folge 403 „NUMMI“ (2010): Die Reportage über das Toyota-GM-Joint-Venture NUMMI schildert das Toyota-Produktionssystem und die Andon-Cord – jede:r am Band kann die Linie stoppen, sobald ein Fehler auftritt, damit er sofort behoben wird, statt hundert fehlerhafte Teile weiterlaufen zu lassen. https://www.thisamericanlife.org/403/nummi

[^cariad-verlust]: „VW meldet Zahlen für 2023: Softwaresparte Cariad weitet Verluste aus“, VDI-Nachrichten (2024): Die 2020 gegründete VW-Software-Tochter CARIAD sollte ein markenübergreifendes Betriebssystem bauen; die operativen Verluste stiegen von rund 2,07 Mrd. Euro (2022) auf 2,39 Mrd. Euro (2023). https://www.vdi-nachrichten.com/wirtschaft/unternehmen/vw-meldet-zahlen-fuer-2023-softwaresparte-cariad-weitet-verluste-aus/

[^cariad-kurs]: „Cariad: VW subsidiary largely discontinues its own software development“, heise online (2025): Bericht über die Abkehr von der Strategie, die Fahrzeugsoftware vollständig selbst zu entwickeln. https://www.heise.de/en/news/Cariad-VW-subsidiary-largely-discontinues-its-own-software-development-10712012.html

[^cariad-partner]: „VW reassigns Cariad as coordinator of Rivian and Xpeng software“, electrive (2025): CARIAD wird von der Eigenentwicklung zum Koordinator zugekaufter und partnerschaftlich entwickelter Software (u. a. mit Rivian und Xpeng) umgebaut. https://www.electrive.com/2025/10/06/vw-reassigns-cariad-as-coordinator-of-rivian-and-xpeng-software/

[^vaillant]: „Vom Konzept zur produktionsreifen Anwendung“, Success Story Vaillant, codecentric: Vaillant erprobte eine mobile App für Fachpartner (Fehlerdiagnose, Dokumentation) zunächst als kleinen, schnell lauffähigen Stand und ließ das Signal aus Feldtests und Fachpartner-Reaktionen kommen, bevor größer investiert wurde. https://www.codecentric.de/success-stories/vaillant

[^everest]: P. G. Firth et al., „Mortality on Mount Everest, 1921–2006: descriptive study“, BMJ 2008: Von den Todesfällen oberhalb 8.000 m ereigneten sich rund 56 % beim Abstieg vom Gipfel – erschöpfte Kräfte und Entscheidungen jenseits der Umkehrzeit, nicht der Aufstieg selbst, sind das größte Risiko. https://wrap.warwick.ac.uk/id/eprint/52009/

[^verlust]: Daniel Kahneman und Amos Tversky, „Prospect Theory: An Analysis of Decision under Risk“, Econometrica 47(2), 1979: Menschen gewichten drohende Verluste stärker als gleich große Gewinne (Verlustaversion); ein Abbruch fühlt sich als sicherer Verlust schwerer an, als die offene Chance des Weitermachens wiegt. https://courses.washington.edu/pbafhall/514/514%20Readings/ProspectTheory.pdf

[^sunk]: Hal R. Arkes und Catherine Blumer, „The Psychology of Sunk Cost“, Organizational Behavior and Human Decision Processes 35(1), 1985: Bereits investiertes Geld, Zeit oder Mühe beeinflusst Entscheidungen, obwohl es nicht zurückzuholen ist – man macht weiter, um das Investierte nicht als verloren anzuerkennen. https://doi.org/10.1016/0749-5978(85)90049-4

[^conf]: Raymond S. Nickerson, „Confirmation Bias: A Ubiquitous Phenomenon in Many Guises“, Review of General Psychology 2(2), 1998: Der Bestätigungsfehler beschreibt die Tendenz, vor allem Information wahrzunehmen und zu gewichten, die die eigene Annahme stützt, und Widersprechendes auszublenden. https://pages.ucsd.edu/~mckenzie/nickersonConfirmationBias.pdf
