...
kind: Standpunkt
cover: ./renaissance-individualsoftware.jpg
coverAlt: "Ein 3D-Drucker fertigt Schicht für Schicht ein einzelnes Objekt auf dem Druckbett."

tldr:
  - "Die Long-Tail-Logik erreicht die Unternehmenssoftware: Wenn eine Person mit den richtigen Werkzeugen und einem darauf umgestellten Vorgehen in wenigen Wochen baut, wofür früher ein Team Monate gebraucht hätte, werden Nischenlösungen wirtschaftlich, die sich als Standardprodukt nie gerechnet hätten."
  - "Der Hebel ist dort am größten, wo die Not am größten ist, allen voran in der fragmentierten und prozesskomplexen Baubranche, in der die herstellereigene Logik jenseits jeder Standardisierung liegt. Realisiert wird er aber zuerst dort, wo ein Unternehmen seine Daten in Ordnung bringt."
  - "Der Engpass verschiebt sich damit von der Technik zur Organisation: nicht mehr, ob eine Individuallösung sich lohnt, sondern welches lange ungelöste Problem zum ersten Mal in Reichweite ist und ob die eigenen Daten maschinenlesbar und konsistent genug gepflegt sind, dass andere damit arbeiten können."
reasoningSeed:
  these: "Sinkende Entwicklungskosten verschieben die Wirtschaftlichkeitsschwelle für Individualsoftware so weit, dass in fragmentierten, wenig digitalisierten Branchen wie dem Bau erstmals der Long Tail passgenauer Nischenwerkzeuge wirtschaftlich wird. Realisiert wird der Hebel aber nur, wo ein Unternehmen die organisatorische Arbeit tut: Daten konsistent pflegen, den Prozess umstellen, den Betrieb automatisieren."
...
Ich habe die letzten Jahre in der Baubranche verbracht und sie ist ein ideales Beispiel, um das Thema anschaulich zu machen: Beim Digitalisierungsindex des IW Köln steht sie ganz hinten und das ist auch meine subjektive Erfahrung. Die Branchengruppe Baugewerbe, Ver- und Entsorgung liegt mit 67,6 Punkten auf dem letzten Platz aller Branchengruppen, weit unter dem Gesamtschnitt von rund 114 und der Spitzengruppe IKT mit 285.[^iw] In der EU arbeiten rund vier Millionen Bauunternehmen, der Großteil davon Kleinbetriebe mit unter 20 Beschäftigten.[^eurostat] Die Wertschöpfungsketten sind fragmentiert, die Prozesse weitgehend papierbasiert, und genau das macht es so schwer, Standardlösungen durchzusetzen.
